...
@click.option("--ffmpeg-audio-opts", "-fao", default="-c:a copy", help="Specify the ffmpeg options to be used for audio track, e.g., '-ar 44100'. [default: '-c:a copy']")
